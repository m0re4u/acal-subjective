...
args=(
  ...
  --task_name MHS-dehumanize
  --num_labels 5
  --text_col text
  --data_id_col comment_id
  --annotator_col annotator_id
  --annotation_col dehumanize
  --result_log_file semdiv_uncertainty_MHS_dehumanize.jsonl
  # active learning args
  --sample_size 2899
  --num_rounds 20
  --datapoints_selection_strategy uncertainty
  --annotator_selection_strategy semantic_diversity
  --warmup_flag true
